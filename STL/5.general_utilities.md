...
using member function ,obj calls them must be the first argument:
```C++
class C{
public:
...
duartion in first line counts with seconds as unit,second counts with minutes as unit,the third counts with mileseconds as unit;
